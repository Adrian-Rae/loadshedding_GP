...
class FitnessFunction:
    ...
    def bind_case(self, args: Dict, target):
        self._fitness_cases.append((args, target))

    def _eval(self, individual: ParseTree):
        accumulator = []
    ...
    def fitness(self, individual: ParseTree, population = None, measure: FitnessMeasure = FitnessMeasure.RAW):
    ...
    def _raw_fitness(self, individual: ParseTree, **kwargs):
        return self._eval(individual)

    def _standardized_fitness(self, individual: ParseTree, **kwargs):
    ...
    def _adjusted_fitness(self, individual: ParseTree, **kwargs):
        return 1 / (1 + self._standardized_fitness(individual))

    def _normalized_fitness(self, individual: ParseTree, population: List[ParseTree], **kwargs):
        return self._adjusted_fitness(individual) / sum([self._adjusted_fitness(individual) for p in population])

    def _hits_ratio(self, individual: ParseTree, **kwargs):
        return len([
